...
export default function NosotrosPoliticas() {
  ...
  const politicas = [
    ...
    },
    {
      ...
      descripcion: "Priorizamos la integridad de nuestro equipo y clientes mediante protocolos avanzados de bioseguridad y gestión de riesgos en todas nuestras operaciones.",
      imagen: "/politica-seguridad.jpg",
      icono: "🛡️",
      tags: ["Salud ocupacional", "Prevención de riesgos", "Protección integral"],
      color: "from-green-500 to-green-700"
    },
    {
      titulo: "Política Ambiental",
      descripcion: "Como especialistas en análisis ambientales, implementamos prácticas sostenibles y minimizamos nuestro impacto ecológico en todas nuestras actividades.",
      imagen: "/politica-ambiental.jpg",
      icono: "🌱",
      tags: ["Sostenibilidad", "Gestión de residuos", "Conservación"],
  ...
  return (
    <section className="w-full overflow-x-hidden bg-white">
      ...
      {/* Sección de políticas - Versión simplificada */}
      <div id="politicas" className="w-full py-20 px-6 bg-white">
        <div className="container mx-auto max-w-6xl">
          ...
          {/* Grid de políticas - Versión más limpia */}
